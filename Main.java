...
public class Main extends JFrame {
	...
	static private final int animationSteps = 125; // Ads Number of animation steps 145
	...
	static void runUI() {
		...
		upButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				slideToTop.start();
//				System.out.println(scrollPane.getViewport().getViewPosition().x);
//				System.out.println(scrollPane.getViewport().getViewPosition().y);
			}
		});
...
//		github.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		...
		// Main Layers (For no overlapping design)
